...
void loop() {
  ...
  digitalWrite(disparo, HIGH); // envío del pulso ultrasónic
  delayMicroseconds(10);      //Hace una pausa en el programa porla cantidad de tiempo (en microsegundos) especificado como parámetro
  digitalWrite(disparo, LOW);      // hay un millón de microsegundos en un segundo
  

  /*
     Medimos la longitud del puso entrante la utilizamos para medir el tiempo que transcurrido entre el envío  del pulso ultrasónico 
  ...
  */
  ...
  /*
    ...
    340 m/s = 0.034 cm/us
    340 m/s es la velocidad del sonido, este parámetro lo podemos ajustar ya que depende de la densidad del aire.
  */
  ...
  */ 
  ...
  Serial.println("Tiempo / Distancia "); /* Serial.println se usa para mostrar la información pasada por parametro y continuar
                                          en la linea de abajo, como si apretarámos "Enter"    */
